...
export function gradient(color1, color2, min, max, value) {
  ...
  let r = parseInt(color1.r + (color2.r-color1.r)*value/(max-min))
  let g = parseInt(color1.g + (color2.g-color1.g)*value/(max-min))
  let b = parseInt(color1.b + (color2.b-color1.b)*value/(max-min))
